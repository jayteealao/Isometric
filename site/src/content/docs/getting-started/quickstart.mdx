...
just need "this shape was tapped." See [Per-Node Interactions](/guides/interactions/).
:::
...
- **[Per-Node Interactions](/guides/interactions/)** — attach `onClick`, `onLongClick`, `alpha`, and stable `nodeId`s to individual shapes.
