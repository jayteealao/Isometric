...
[Gestures explanation](/guides/gestures/#why-ondrag-is-a-delta-not-a-position).
...
[Gestures](/guides/gestures/#why-ondrag-is-a-delta-not-a-position) for the rationale.
:::
...
See [Camera & Viewport](/guides/camera/) for the full `CameraState` reference, and
[Scene Configuration](/reference/scene-config/) for the `GestureConfig` parameter table.
