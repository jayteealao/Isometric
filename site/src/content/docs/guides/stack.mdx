...
[Per-Node Interactions — Alpha on groups](/guides/interactions/#alpha-on-groups)):
...
- [Per-Node Interactions](/guides/interactions/) — click handlers, alpha, and ids on stacked shapes
