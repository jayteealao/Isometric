...
See [Engine — Tile Coordinate Helpers](/reference/engine/#tile-coordinate-helpers) for full
...
- [Stack guide](/guides/stack/) — arrange shapes in a 1D line along any world axis
- [Gestures — Tile Grid Tap Routing](/guides/gestures/#tile-grid-tap-routing) — combining tile taps with drag gestures
- [Per-Node Interactions](/guides/interactions/) — `onClick`/`onLongClick`/`onDoubleClick`, alpha, and ids on the shapes you render inside tiles
- [Drag & Camera](/guides/drag-and-camera/) — pan/zoom the grid, or tap-select-then-drag a node with `NodeDragState`
